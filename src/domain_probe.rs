...
use mochios_mdriver_protocol::block::{
...
use mochios_mdriver_protocol::{
    BLOCK_BUFFER_COUNT as MDRIVER_BLOCK_BUFFER_COUNT,
    BLOCK_BUFFER_FIRST_PAGE as MDRIVER_BLOCK_BUFFER_FIRST_PAGE,
    BLOCK_DATA_PAGE as MDRIVER_BLOCK_DATA_PAGE, BLOCK_REQUEST_KIND as MDRIVER_BLOCK_REQUEST_KIND,
    BLOCK_RESPONSE_KIND as MDRIVER_BLOCK_RESPONSE_KIND,
    BLOCK_RING_GENERATION as MDRIVER_BLOCK_RING_GENERATION,
    BLOCK_RING_PAGE as MDRIVER_BLOCK_RING_PAGE, BLOCK_RING_PORT as MDRIVER_BLOCK_RING_PORT,
    CONTROL_IRQ_PORT as MDRIVER_CONTROL_IRQ_PORT, CONTROL_PORT as MDRIVER_CONTROL_PORT,
    CONTROL_REQUEST_KIND as MDRIVER_CONTROL_REQUEST_KIND,
...
static START_MESSAGE: &[u8] = b"mDriver protocol probe entered\n";
